...
namespace MusicTheory
{
    ...
    public class PitchClass24 : System.IComparable
    {
        ...
        /// </summary>
        public string PitchClassString
        {
            get
            {
                if (_pitchClassInteger > 9)
                    return _pitchClassInteger.ToString();
                else
                    return "0" + _pitchClassInteger.ToString();
            }
            set
            {
                UpdatePitchClass(System.Int32.Parse(value));
            }
        }
        ...
        /// <summary>
        /// Determines if a character is a valid pitch class string
        /// </summary>
        /// <param name="c">The character</param>
        /// <returns>True if it is valid; false otherwise</returns>
        public static bool IsValidPitchClassString(string pcString)
        {
            int val = int.Parse(pcString);
            if (val >= 0 && val < NUM_PC)
                return true;
            else
                return false;
